...
<div class="row"> 
    <div class="col-sm-6"> 
        ...
        <select name="domaciTim" id="domaciTim" >';
            ...
            echo '<option value="';echo $red->idTima; echo '" selected>'; echo $red->nazivTima; echo '</option>';
        }else{
        echo '<option value="';echo $red->idTima; echo '">'; echo $red->nazivTima; echo '</option>';        
                }
            endwhile; 
        echo '</select>
    </div>
...
<div class="row">
    <div class="col-sm-6">
        ...
        <input type="text" name="brGolDom" id="brGolDom" value="'; echo $brGolDom; echo'">
    </div>
    <div class="col-sm-6">
        <label for="brGolGost">Broj golova gostujuceg tima:</label>
        <input type="text" name="brGolGost" id="brGolGost" value="'; echo $brGolGo; echo'">
    </div>
</div>
<div class="row">
    <div class="col-sm-4">
        <label for="grad">Grad:</label>
        <input type="text" name="grad" id="grad" value="'; echo  $grad; echo'">
    </div>
    <div class="col-sm-4">
        ...
        <select name="liga-select" id="liga-select">';
            ...
            while ($red = $mydb2->getResult()->fetch_object()) :
                if($red->idLiga==$idLig){
                echo '<option value="';echo $red->idLiga; echo'" selected>';echo $red->nazivLige; echo'</option>';
                }else{
                    echo '<option value="';echo $red->idLiga; echo'">';echo $red->nazivLige; echo'</option>';
    ...
    <div class="col-sm-4">
        ...
        <input type="date"  name="datum" id="datum" value="'; echo date("Y-m-d",strtotime($dat));
        echo '">
    </div>
</div>
<div class="row">
    <input type="submit" name="sacuvaj" id="sacuvaj" value="Sacuvaj" style="display: none;">
    <button type="submit" name="izmeni" id="izmeni" value="';echo $q; echo'" style="display: block;">Izmeni</button>
